...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative overflow-hidden pt-10 sm:pt-16">
      ...
      {/* Ambient glow orbs — now with CSS float animation */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/4 top-16 h-72 w-72 rounded-full bg-indigo-300/20 blur-3xl animate-float-a"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-1/4 top-32 h-56 w-56 rounded-full bg-violet-300/15 blur-3xl animate-float-b"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 bottom-24 h-40 w-40 -translate-x-1/2 rounded-full bg-sky-200/10 blur-3xl animate-float-c"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-24 pt-8 sm:px-8 sm:pb-32 sm:pt-14">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Stat tiles — staggered scaleUp entrance */}
          <motion.div
            initial="hidden"
            animate="visible"
            variants={{
          ...
          >
            {statItems.map((stat, i) => (
              <motion.div
                ...
                className={`flex flex-col items-center justify-center p-2 text-center${i > 0 ? " border-l border-slate-200/60" : ""}`}
              >
